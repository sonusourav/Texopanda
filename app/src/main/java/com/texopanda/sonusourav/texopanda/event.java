    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                //btnSkbtnip.setVisibility(View.GONE);
            ...
            if (position == 0){
                ...
                btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent in = new Intent(event.this, cs.class);
                        startActivity(in);
                    }
                });}
            else if (position == 1){
                ImageButton btn1 = view.findViewById(R.id.imagebutton2);
                btn1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent in = new Intent(event.this, fifa.class);
                        startActivity(in);
                    }
                });}
            else{
                ImageButton btn3 = view.findViewById(R.id.imagebutton3);
                btn3.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent in = new Intent(event.this, pubg.class);
                        startActivity(in);
                    }
                });}
